...
### Шаг 3 Изменение конфигурации appsettings.json в папке Doca.Server
#### Измените строку подключения к серверу где лежит бд (MySql)
...
#### Создайте и измените ключ для JWT 
