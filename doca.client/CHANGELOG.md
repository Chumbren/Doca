...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest doca.client -- --template=react  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`doca.client.esproj`).
